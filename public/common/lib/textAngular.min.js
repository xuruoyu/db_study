!function (a, b) {
    b["true"] = a, angular.module("textAngularSetup", []).value("taOptions", {
        toolbar: [["h4", "p"], ["justifyLeft", "justifyCenter", "justifyRight"]],
        classes: {
            focussed: "focussed",
            toolbar: "btn-toolbar",
        ...
        html: {buttontext: "切换HTML", tooltip: "Toggle html / Rich Text"},
        ...
        m.constant("taRegisterTool", c), m.value("taTools", n), m.config([function () {
            ...
            return {
                require: "ngModel", scope: {}, link: function (j, p, q, r) {
                    var s, t, u, v = void 0 !== p.attr("contenteditable") && p.attr("contenteditable"), w = v || "textarea" === p[0].tagName.toLowerCase() || "input" === p[0].tagName.toLowerCase(), x = !1, y = !1, z = q.taUnsafeSanitizer || o.disableSanitizer;
